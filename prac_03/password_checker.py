...
def is_valid_password(password):
    ...
    print(f"Number of lowercase characters: {number_of_lower}")
    print(f"Number of uppercase characters: {number_of_upper}")
    print(f"Number of digits: {number_of_digit}")
    print(f"Number of special characters: {number_of_special}")
